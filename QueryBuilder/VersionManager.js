  ...
  function VersionManager(){
    this.versions = [{
      ...
      upgrader: function(oldConfig){
        ...
        if(newConfig.widgetSwitch == 'Query'){
            var query = null;
      ...
      upgrader: function(oldConfig){
        var newConfig = oldConfig;
        if(newConfig.widgetSwitch == 'Filter'){
          var filters = newConfig.filters;
          for(var i = 0; i < filters.length; i++){
            filters[i].enableMapFilter = true;
          }
        }else if(newConfig.widgetSwitch == 'Query'){
      ...
      version: '2.6',
      upgrader: function(oldConfig){
        if(oldConfig.widgetSwitch == 'Filter'){
