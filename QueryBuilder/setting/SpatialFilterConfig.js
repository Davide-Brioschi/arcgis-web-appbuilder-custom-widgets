...
function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, on, query, lang,
  html, array, SearchDistance, RelationshipsSelector, LayerInfos, FeaturelayerChooserFromMap, LayerChooserFromMapWithDropbox,
  jimuUtils, queryUtils, Popup, CheckBox) {
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    setConfig:function(config){
      ...
      if(this.config.useFeatures){
        ...
        // select layers
        if(this.config.useFeatures.selectLayerId){
          this.selectLayerId = this.config.useFeatures.selectLayerId;
          var layerInfo = this.layerInfosObj.getLayerInfoById(this.selectLayerId);
          var selectLayer = layerInfo.layerObject;
          this.layerChooserFromMapWithDropbox.setSelectedLayer(selectLayer);
        }
    ...
    getConfig: function(){
      ...
      if(this.cbxUseFeatures.getValue()){
        ...
        if(this.selectLayerId){
          config.useFeatures.selectLayerId = this.selectLayerId;
        }
