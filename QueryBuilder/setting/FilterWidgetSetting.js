...
define([
  ...
  'dojo/text!./FilterWidgetSetting.html',
  'esri/lang',
  'jimu/utils',
...
function(on, query, html, lang, array, declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template,
  esriLang, jimuUtils, BaseWidgetSetting, SingleSetting, LayerInfos) {
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    postMixInProperties:function(){
      ...
      this.noTaskNls = this.nls.noFilterTasksTip;
