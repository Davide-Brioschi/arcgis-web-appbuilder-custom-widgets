...
function(Evented, declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, registry,
  lang, html, array, on, a11yclick, aspect, query, SingleFilterSet, SingleFilter) {
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    _initSelf:function(){
      ...
      this.own(on(this.btnAddSet, a11yclick, lang.hitch(this, function(){
        this._addSingleFilterSet();
        this.emit('change');
      })));
      ...
      if(this.partsObj){
        ...
        if(parts.length === 0){
          ...
          array.forEach(parts, lang.hitch(this, function(part){
            if(part.parts){
              //SingleFilterSet
              this._addSingleFilterSet(part);
            } else if(part.fieldObj && part.operator && part.valueObj){
              //SingleFilter
    ...
    _addSingleFilterSet:function(/*optional*/ part){
      var args = {
        url: this.url,
      ...
      var filterSet = new SingleFilterSet(args);
