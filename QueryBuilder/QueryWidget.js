...
define([
  ...
  function(on, keys, query, Deferred, lang, html, array, all, declare, _TemplatedMixin, _WidgetsInTemplateMixin, template, jimuUtils, BaseWidget,
      ...
      */
      ...
      _onTabHeaderClicked: function(event){
        ...
        if(target === this.taskQueryItem){
          ...
          // new custom
          if(this._selectedTab == 'Task'){
            this._switchToResultTab();
            this._selectedTab = 'Result';
            //var layerInfoArray = this.layerInfosObj.getLayerInfoArray();
            var layerInfoArray = this.layerInfosObj.getLayerInfoArrayOfWebmap();
            if(this.config.hideNonQueriedLayers){
                setTimeout(function(){
