...
define([
  ...
  'dojo/text!./SpatialFilterByFeatures.html',
  'dojo/on',
  'dojo/Evented',
  'dojo/Deferred',
  'dojo/_base/html',
  ...
  var clazz = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    postCreate:function(){
      ...
      var layerChooser = new FeaturelayerChooserFromMap({
        ...
        showTable: false,//if true, types will be ignored for table layer  // new custom
        onlyShowVisible: false,
        updateWhenLayerInfosIsShowInMapChanged: true,
        onlyShowWebMapLayers: true,  // new custom
          ...
          if(features.length === 0){
            if(type === 3){
              ...
              if(cachedFeatures){
                ...
                this._layerAllFeaturesCache[info.layer.id] = null;
              }
            }
          }
        }
