...
define([
  ...
  function(declare, on, lang, BaseWidgetSetting, LayerInfos, _WidgetsInTemplateMixin, _FeaturelayerSourcePopup, LayerSelector) {
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig: function(config) {
        ...
        if(this.config.legendTableUrl){
          this.legendTableUrlTextBox.set('value', this.config.legendTableUrl);
        }
      ...
      _setLegendTableUrl: function(){
          ...
          this.own(on(featurePopup, 'ok', lang.hitch(this, function(item){
            if(this.config.legendTableUrl === item.url){
              featurePopup.close();
              return;
            }
            this.config.legendTableUrl = item.url;
            this.legendTableUrlTextBox.set('value', item.url);
            featurePopup.close();
          })));
      ...
      _removeLegendTableUrl: function(){
        delete this.config.legendTableUrl;
        this.legendTableUrlTextBox.set('value', "");
      }
