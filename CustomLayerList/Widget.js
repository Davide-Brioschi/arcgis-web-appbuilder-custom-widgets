...
define([
  ...
  query, registry, LayerListView, LayerFilter, NlsStrings, LayerInfos, FilterManager) {
    ...
    var clazz = declare([BaseWidget], {
      ...
      _removeLayerFilters: function(){
          // Remove Layer Filters
          array.forEach(this.operLayerInfos.getLayerInfoArray(), function(layerInfo) {
            this.filterManager.applyWidgetFilter(layerInfo.id, this.id, "", null, null, false);
          }, this);
      },

      destroy: function() {
        this._removeLayerFilters();
        this._clearLayers();
        this.inherited(arguments);
      },
