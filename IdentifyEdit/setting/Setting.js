...
define([
  ...
  function(
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      baseClass: 'jimu-widget-identify-edit-setting',
      // selectLayer: null,
      // tooltipDialog: null,
      // featurelayers: [],
      // indexLayer: -1,
      ...
      _initToolbar: function() {
        this.showPanel.setValue(this.config.editor.showPanel);
      ...
      setConfig: function() {
        ...
        if(this.config.editor.blockedUrl){
          this.blockedUrlTextBox.set('value', this.config.editor.blockedUrl);
        }
      },
      ...
      _resetToolbarConfig: function() {
        this.config.editor.showPanel = this.showPanel.checked;
      ...
      _setBlockedUrl: function(){
          ...
          this.own(on(featurePopup, 'ok', lang.hitch(this, function(item){
            if(this.config.editor.blockedUrl === item.url){
              featurePopup.close();
              return;
            }
            this.config.editor.blockedUrl = item.url;
            this.blockedUrlTextBox.set('value', item.url);
            featurePopup.close();
          })));
      ...
      _removeBlockedUrl: function(){
         delete this.config.editor.blockedUrl;
         this.blockedUrlTextBox.set('value', "");
      }
    });
  });
