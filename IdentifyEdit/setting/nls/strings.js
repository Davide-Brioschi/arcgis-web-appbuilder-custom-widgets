define({
  root: ({
    ...
    editableLayersSetting: "Editable layers settings for total users",
    ...
    blockedSetting: "Blocked layers and fields settings for each users",
    blockedTaskUrl: "Blocked Setting URL",
    setTask: "Set",
    removeTask: "Remove",
